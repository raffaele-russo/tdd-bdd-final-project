...
class TestProductRoutes(TestCase):
    ...
    def get_product_not_found(self):
    ...
    def update_product_not_found(self):
    ...
    def test_query_by_category(self):
        """It should Get a list of Products with a given category"""
        products = self._create_products(5)
    ...
    def test_query_by_availability(self):
        """It should Get a list of Products with a given availability"""
        products = self._create_products(5)
    ...
    def get_product_count(self):
        """save the current nFumber of products"""
        response = self.client.get(BASE_URL)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        data = response.get_json()
